...
export const UserKindSelector = ({
  ...
  return (
    <div
      className={`${
        show ? "flex" : "hidden"
      } flex-col flex-1 p-8 sm:p-16 justify-center items-stretch`}
    >
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-4 flex-1 p-8 sm:p-16">
        ...
        >
          ...
          <h1 className="text-3xl font-semibold max-w-lg">
          ...
          <h2 className="justify-self-end text-lg font-normal">
        ...
        >
          ...
          <ul className="px-4 py-8 text-lg font-light max-w-md gap-2 flex flex-col list-disc text-zinc-700 text-left capitalize">
            <li>
              Reduce Complexity by Automatically Generating Reports From
              Connected Datasources
            </li>
            <li>
              Increase Customer Happiness by Automatically handling custom
              modifications to reports
            </li>
            <li>
              Increase retention by Understanding how your customers think of
              your value
            </li>
          </ul>
        </button>
